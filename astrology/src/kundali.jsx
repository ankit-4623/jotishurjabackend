...
const translations = {
  en: {
    ...
    navAbout: "ABOUT",
    navContact: "CONTACT",
    heroTitle: "Astro Solutions & Remedies",
    heroDescription:
      "Discover personalized astrological solutions including horoscopes, Lal Kitab remedies, and Kundali services to balance your life’s energies.",
    sectionTitle: "Explore Astro Solutions",
    searchPlaceholder: "Search by solution (e.g., Horoscope, Lal Kitab)",
    noResults: "No solutions found matching your search.",
    benefits: "Benefits:",
    price: "Price:",
    buyButton: "Buy Now",
    uspTitle: "Why Choose Our Astro Solutions",
    uspAuthenticityTitle: "Expert Guidance",
    uspAuthenticityDescription:
      "Solutions crafted by experienced astrologers based on Vedic principles.",
    uspDeliveryTitle: "Digital Delivery",
    uspDeliveryDescription:
      "Receive your reports and remedies via email or app instantly.",
    uspAlignmentTitle: "Personalized Remedies",
    uspAlignmentDescription:
      "Tailored to your birth chart for maximum effectiveness.",
    footerLogo: "Jyotish Urja",
    footerDescription:
      "Empowering your journey with Vedic astrology solutions and remedies.",
    ...
    chatbotWelcome: "Welcome to Jyoti! 🌟 How can I help with astro solutions?",
    chatbotSupport: "Astro Support",
    chatbotSend: "Send",
    formTitle: "Purchase Astro Solution",
    formName: "Name",
    formDOB: "Date of Birth (YYYY-MM-DD)",
    formBirthTime: "Birth Time (HH:MM)",
    formBirthPlace: "Birth Place",
    formSolutionType: "Solution Type",
    formSubmit: "Submit",
    kundaliRate: "Kundali Making Rate: ₹1500",
    kundaliDescription:
      "Detailed birth chart analysis with planetary positions and predictions.",
  },
  hi: {
    logo: "ज्योतिष ऊर्जा",
    navHome: "होम",
    ...
    navContact: "संपर्क",
    heroTitle: "ज्योतिष समाधान और उपाय",
    heroDescription:
      "वैयक्तिकृत ज्योतिषीय समाधानों की खोज करें जिसमें राशिफल, लाल किताब उपाय, और कुंडली सेवाएँ शामिल हैं।",
    sectionTitle: "ज्योतिष समाधानों का अन्वेषण करें",
    searchPlaceholder: "समाधान द्वारा खोजें (उदाहरण, राशिफल, लाल किताब)",
    noResults: "आपकी खोज से मिलते-जुलते कोई समाधान नहीं मिले।",
    benefits: "लाभ:",
    price: "मूल्य:",
    buyButton: "अभी खरीदें",
    uspTitle: "हमारे ज्योतिष समाधान क्यों चुनें",
    uspAuthenticityTitle: "विशेषज्ञ मार्गदर्शन",
    uspAuthenticityDescription:
      "वैदिक सिद्धांतों पर आधारित अनुभवी ज्योतिषियों द्वारा तैयार समाधान।",
    uspDeliveryTitle: "डिजिटल डिलीवरी",
    uspDeliveryDescription:
      "अपनी रिपोर्ट और उपाय ईमेल या ऐप के माध्यम से तुरंत प्राप्त करें।",
    uspAlignmentTitle: "वैयक्तिकृत उपाय",
    uspAlignmentDescription:
      "आपकी जन्म कुंडली के अनुसार अधिकतम प्रभावशीलता के लिए अनुकूलित।",
    footerLogo: "ज्योतिष ऊर्जा",
    footerDescription:
      "ज्योतिष समाधानों और उपायों के साथ आपकी यात्रा को सशक्त बनाएं।",
    ...
    chatbotWelcome:
      "ज्योति में आपका स्वागत है! 🌟 ज्योतिष समाधानों में कैसे मदद कर सकता हूँ?",
    chatbotSupport: "ज्योतिष समर्थन",
    chatbotSend: "भेजें",
    formTitle: "ज्योतिष समाधान खरीदें",
    formName: "नाम",
    formDOB: "जन्म तिथि (YYYY-MM-DD)",
    formBirthTime: "जन्म समय (HH:MM)",
    formBirthPlace: "जन्म स्थान",
    formSolutionType: "समाधान प्रकार",
    formSubmit: "जमा करें",
    kundaliRate: "कुंडली बनाने का शुल्क: ₹1500",
    kundaliDescription:
      "ग्रहों की स्थिति और भविष्यवाणियों के साथ विस्तृत जन्म कुंडली विश्लेषण।",
  },
};

const AstroSolutions = () => {
  ...
  const solutions = [
    {
      ...
      name_hi: "राशिफल",
      benefits:
        "Daily, weekly, and monthly predictions based on your zodiac sign.",
      benefits_hi:
        "आपकी राशि के आधार पर दैनिक, साप्ताहिक और मासिक भविष्यवाणियाँ।",
      price: 500,
    },
    {
      name: "Lal Kitab Remedies",
      name_hi: "लाल किताब उपाय",
      benefits:
        "Personalized remedies to mitigate planetary doshas and improve life aspects.",
      benefits_hi:
        "ग्रह दोषों को कम करने और जीवन के पहलुओं को सुधारने के लिए वैयक्तिकृत उपाय।",
      price: 1000,
    },
    {
      name: "Kundali",
      name_hi: "कुंडली",
      benefits:
        "Detailed birth chart with planetary positions and life predictions.",
      benefits_hi:
        "ग्रहों की स्थिति और जीवन भविष्यवाणियों के साथ विस्तृत जन्म कुंडली।",
      price: 1500,
    },
  ];
  ...
  const filteredSolutions = solutions.filter((solution) =>
    language === "en"
      ...
      : solution.name_hi.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  const quickMessages =
    language === "en"
      ...
      : solutions.map((sol) => sol.name_hi);

  const handleBuy = (solution) => {
    setSelectedSolution(solution);
    setFormData({
      ...formData,
      solutionType: language === "en" ? solution.name : solution.name_hi,
    });
    setIsModalOpen(true);
  };
      ...
      <style>
        {`
          ...
          * {
          ...
          .solution-card .buy-button::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
          ...
          .solution-card .buy-button:hover::before {
            left: 100%;
          }

          .solution-card .buy-button:hover {
      ...
      <div className="main-container" lang={language}>
        ...
        <section className="hero-section">
          <div className="hero-content">
            <svg className="astro-svg" viewBox="0 0 200 200">
              <path
                className="astro-path"
            ...
            {filteredSolutions.length > 0 ? (
              filteredSolutions.map((solution, index) => (
                <div key={index} className="solution-card">
                  ...
                  <h3>
                    {language === "en" ? solution.name : solution.name_hi}
                  </h3>
                  <p>
                    <strong>{translations[language].benefits}</strong>{" "}
                    {language === "en"
                      ? solution.benefits
                      : solution.benefits_hi}
                  </p>
                  <p className="price">₹{solution.price}</p>
                  <button
                    className="buy-button"
                    onClick={() => handleBuy(solution)}
                  >
        ...
        <div className="chatbot-container">
          <div className="chatbot-header">
            ...
            <div>
              <h3>Jyoti</h3>
              <p>{translations[language].chatbotSupport}</p>
            </div>
          </div>
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={handleFormSubmit}>
                ...
                <input
                  type="date"
                  name="dob"
                  placeholder={translations[language].formDOB}
                  value={formData.dob}
                  onChange={handleChange}
                  required
                />
                <input
                  type="time"
                  name="birthTime"
                  placeholder={translations[language].formBirthTime}
                ...
                <input
                  type="text"
                  name="birthPlace"
                  placeholder={translations[language].formBirthPlace}
                ...
                <input
                  ...
                  readOnly
                />
                {selectedSolution?.name === "Kundali" && (
                  <div className="kundali-info">
                    <p>{translations[language].kundaliRate}</p>
                    <p>{translations[language].kundaliDescription}</p>
                  </div>
                )}
                <button type="submit">
                  {translations[language].formSubmit}
                </button>
              </form>
            </div>
          </div>
