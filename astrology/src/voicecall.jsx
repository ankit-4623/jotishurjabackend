...
const VoiceCall = () => {
  ...
  useEffect(() => {
    if (!isChatOpen && messages.length === 0) {
      setMessages([
        {
          sender: "Jyoti",
          text: "Welcome to Jyoti, your Divine Light! 🌟 How can I assist you with your voice call consultation?",
        },
      ]);
    }
  }, [isChatOpen]);
  ...
  const sendMessage = (text) => {
    ...
    const responses = {
      "Consultation Cost":
        "The voice call consultation costs ₹1000 for a 30-minute session.",
      "Session Duration":
        "Each voice call consultation lasts 30 minutes, providing ample time for personalized guidance.",
      "Astrologer Expertise":
        "Our astrologers are seasoned experts in Vedic astrology, blending ancient wisdom with modern insights.",
      "Payment Process":
        "Payments are securely processed via Razorpay. Fill out the form and proceed to payment to book your session.",
      "Schedule Call":
        "After payment, our team will contact you to schedule your voice call at a convenient time.",
    };
    ...
    <>
      <style>
        {`
          ...
          * {
          ...
          @keyframes glow {
            0% { box-shadow: 0 0 25px rgba(212, 175, 55, 0.4), inset 0 0 15px rgba(212, 175, 55, 0.1); transform: scale(1); }
            100% { box-shadow: 0 0 40px rgba(212, 175, 55, 0.7), inset 0 0 25px rgba(212, 175, 55, 0.2); transform: scale(1.05); }
          }
          ...
          .spiritual-svg:hover .lotus-petals {
      ...
      <div className="main-container">
        ...
        <section className="hero-section">
          <div className="hero-content">
            <svg className="spiritual-svg" viewBox="0 0 200 200">
              <path
                className="lotus-petals"
                d="M100 30 C110 10, 90 10, 100 30 C120 10, 140 20, 130 40 C150 20, 170 30, 160 50 C180 30, 190 50, 170 70 C190 50, 180 80, 160 90 C180 80, 170 100, 150 110 C170 100, 150 120, 130 120 C140 120, 120 140, 100 130 C80 140, 60 120, 70 120 C50 120, 30 100, 50 110 C30 100, 20 80, 40 90 C20 80, 10 50, 30 70 C10 50, 20 30, 40 50 C30 20, 50 10, 70 40 C60 20, 80 10, 100 30"
                fill="rgba(212, 175, 55, 0.2)"
                stroke="#d4af37"
                strokeWidth="2"
              />
              <text x="100" y="110" className="om-symbol">
                ॐ
              </text>
            </svg>
            <h1>Voice Call Consultation</h1>
            <p>
              Connect with our expert astrologers for personalized guidance and
              cosmic insights tailored to your life's journey.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <h2 className="section-title">Book Your Voice Call</h2>
          <div className="form-container">
            <div className="card">
              <div className="card-icon">📞</div>
              <h3>Voice Call Consultation</h3>
              <p>
                ₹1000 for a 30-minute session with our Vedic astrology experts.
              </p>
        ...
        <section className="section">
          ...
          <div className="usp-container">
            <div className="usp-card">
              ...
              <p>
                Our consultations are rooted in ancient Vedic wisdom, ensuring
                accurate and authentic astrological guidance.
              </p>
            </div>
            <div className="usp-card">
              ...
              <p>
                Connect with seasoned astrologers who blend traditional
                knowledge with modern insights for personalized advice.
              </p>
            </div>
            <div className="usp-card">
              <div className="usp-icon">💎</div>
              ...
              <p>
                We integrate astrology, gemstone recommendations, and sacred
                rituals to empower your life's journey.
              </p>
            </div>
            <div className="usp-card">
              <div className="usp-icon">📱</div>
              ...
              <p>
                Seamless booking and secure payments make spiritual guidance
